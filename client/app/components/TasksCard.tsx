...
const TasksCard = ({ task }: { task: Task }) => {
  const { _id, title, description, date, isCompleted } = task;
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center">
        <span
          className={`text-md px-4 py-2 rounded-full ${isCompleted ? "bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-200" : "bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-200"}`}
        >
